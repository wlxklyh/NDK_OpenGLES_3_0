...
void BasicLightingSample::SelfDraw(int screenW, int screenH) {
...
void BasicLightingSample::Draw(int screenW, int screenH) {
    ...
    //SelfDraw(screenW, screenH);

    tri_sample.Draw(screenW, screenH);

	ui_sample.Draw(screenW,screenH);
...
void BasicLightingSample::UpdateTransformMatrix(float rotateX, float rotateY, float scaleX,
                                                float scaleY) {
    tri_sample.UpdateTransformMatrix(rotateX, rotateY, scaleX, scaleY);
    ui_sample.UpdateTransformMatrix(rotateX, rotateY, scaleX, scaleY);
